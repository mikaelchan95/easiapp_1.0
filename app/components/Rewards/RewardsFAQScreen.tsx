...
interface FAQItem {
  ...
  question: string;
  answer: string;
  category: 'earning' | 'spending' | 'tiers' | 'vouchers' | 'expiry' | 'general';
}
...
const ExpandableCard: React.FC<ExpandableCardProps> = ({ item, isExpanded, onToggle }) => {
  ...
  return (
    <View style={styles.faqCard}>
      <TouchableOpacity style={styles.faqHeader} onPress={onToggle} activeOpacity={0.7}>
        ...
        <Animated.View style={[styles.faqIcon, { transform: [{ rotate: iconRotation }] }]}>
...
const FAQ_DATA: FAQItem[] = [
  ...
  // Vouchers
  {
    ...
    answer: 'Vouchers are valid for 30 days from the date of redemption. You\'ll receive a confirmation email with your voucher code and expiry date.\n\nWe send reminder notifications:\n• 7 days before expiry\n• 3 days before expiry\n• Final reminder on expiry day\n\nExpired vouchers cannot be extended or reactivated.'
  },
  {
    id: 'voucher-2',
    category: 'vouchers',
    question: 'What happens if my voucher expires?',
    answer: 'Expired vouchers cannot be used and the points used to redeem them are not refunded. This policy ensures fair usage of the rewards program.\n\nTo avoid losing vouchers:\n• Set calendar reminders\n• Enable push notifications\n• Check your voucher tracking regularly\n• Plan your purchases in advance'
  },
  {
    id: 'voucher-3',
    category: 'vouchers',
    question: 'Can I transfer vouchers to someone else?',
    answer: 'Vouchers are tied to your account and cannot be transferred to other users. However, for corporate accounts, vouchers can be used by authorized team members on the same account.\n\nIf you need to make a purchase for someone else, you can place the order using your voucher and arrange delivery to their address.'
  },
          ...
          {categories.map(category => (
            ...
            >
              <Ionicons 
                ...
                size={16} 
                color={selectedCategory === category.id ? COLORS.card : COLORS.textSecondary} 
              />
              <Text style={[
      ...
      >
        ...
        <View style={styles.headerInfo}>
          ...
          <Text style={styles.headerSubtitle}>
            Everything you need to know about earning, spending, and managing your rewards points.
          </Text>
        </View>
        ...
        <View style={styles.supportSection}>
          <View style={styles.supportCard}>
            ...
            <Text style={styles.supportText}>
              Our customer support team is here to help with any rewards-related questions.
            </Text>
