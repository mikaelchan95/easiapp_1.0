...
export default function AddressDetailsForm({
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.contactNumber.trim()) {
      ...
      if (cleanNumber.length < 8) {
        newErrors.contactNumber =
          'Please enter a complete Singapore phone number';
      }
    }
    ...
    if ((hasFromTime && !hasToTime) || (!hasFromTime && hasToTime)) {
      newErrors.preferredTime =
        'Please set both start and end times for your preferred window';
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const details: DeliveryDetails = {
        ...
        preferredTime:
          formData.preferredTimeFrom.trim() && formData.preferredTimeTo.trim()
            ? {
                from: formData.preferredTimeFrom.trim(),
                to: formData.preferredTimeTo.trim(),
              }
            : undefined,
      };
  ...
  const handleCancel = () => {
    ...
    if (hasContent) {
      Alert.alert('Discard Changes?', 'Your address details will be lost.', [
    ...
    return (
      <View
        style={[
          ...
          completedSections.save && styles.stepContainerCompleted,
        ]}
      >
        <TouchableOpacity
  ...
  const renderCoreStep = () => {
    ...
    return (
      <View
        style={[
          styles.stepContainer,
          completedSections.core && styles.stepContainerCompleted,
        ]}
      >
        <TouchableOpacity
          style={styles.stepHeader}
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                style={[
                  styles.textInput,
                  styles.textArea,
                  focusedField === 'deliveryInstructions' &&
                    styles.inputFocused,
                ]}
                ...
                onChangeText={text =>
                  updateFormData('deliveryInstructions', text)
                }
              ...
              <Text style={styles.helperText}>
                Optional • Helps ensure successful delivery
              </Text>
            </View>
          </Animated.View>
        )}
        ...
        {expandedSteps.preferences && (
          <Animated.View style={[styles.stepBody, { opacity: fadeAnim }]}>
            ...
            <View style={styles.inputGroup}>
              ...
              <Text style={styles.helperText}>
                Alternative contact for delivery updates
              </Text>
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.timeRangeContainer}>
                <TextInput
                  ...
                  onChangeText={text =>
                    updateFormData('preferredTimeFrom', text)
                  }
