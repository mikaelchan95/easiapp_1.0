...
const productImageUpdates = [
  ...
  {
    sku: 'MAC18-SC-700',
    imageUrl: 'https://vqxnkxaeriizizfmqvua.supabase.co/storage/v1/object/public/product-images/products/macallan-18-sherry-cask.webp'
  },
  {
    sku: 'MAC25-SO-700',
  ...
  {
    sku: 'MAC30-SC-700',
    imageUrl: 'https://vqxnkxaeriizizfmqvua.supabase.co/storage/v1/object/public/product-images/products/macallan-30-sherry-cask.webp'
  },
  {
    sku: 'CM2015-750',
    imageUrl: 'https://vqxnkxaeriizizfmqvua.supabase.co/storage/v1/object/public/product-images/products/chateau-margaux-2015.webp'
  },
  {
    sku: 'HEN-PAR-700',
    imageUrl: 'https://vqxnkxaeriizizfmqvua.supabase.co/storage/v1/object/public/product-images/products/hennessy-paradis.webp'
  },
  {
    sku: 'JW-BLUE-700',
    imageUrl: 'https://vqxnkxaeriizizfmqvua.supabase.co/storage/v1/object/public/product-images/products/johnnie-walker-blue.webp'
  }
];

async function updateProductImages() {
  try {
    console.log('🔄 Updating product image URLs with correct products/ subfolder path...');
